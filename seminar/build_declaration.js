...
const table = new Table({
  ...
  rows: [
    ...
    new TableRow({ children: [
      cell('ChatGPT (OpenAI)', COLS[0]),
      cell('[להשלים: באיזה חלק של העבודה נעשה שימוש]', COLS[1]),
      cell('[להשלים: מטרת השימוש, למשל חיפוש רעיונות, סיכום מאמרים או שיפור ניסוח]', COLS[2]),
      cell('[להשלים קישור]', COLS[3]),
    ]}),
  ],
});
