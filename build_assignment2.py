...
p = para(doc)
T(p, "הסימן המובהק של הנוכחות היהודית היה ריכוזה בעיר. בעוד רוב האוכלוסייה "
     "הערבית ישבה בכפרים, ישבו למעלה מ-85 אחוזים מן היהודים בערים. בן-אריה "
     "הראה כי הגידול היהודי בירושלים הוא שהפך אותה לעיר הגדולה בארץ: "
     "מכ-2,000 יהודים בראשית המאה לכ-45,000 ערב מלחמת העולם הראשונה, וכבר "
     "בשנות השבעים של המאה התשע-עשרה היוו בה היהודים רוב יחסי.")
N(p, 1)
...
T(p, "המעורבות התבטאה בראש ובראשונה בבנייה. מהקמת משכנות שאננים ב-1860 ועד "
     ...
     "ביוזמת חברות בנייה, כוללים ופילנתרופים, עד שערב המלחמה ישבה כמחצית "
     "מאוכלוסיית העיר מחוץ לחומות. ייחודה של בנייה זו היה במימונה: היא לא "
     "צמחה מן הכלכלה המקומית אלא מהון שהוזרם מחוץ לארץ, מכספי החלוקה, "
     "ממונטיפיורי ומהברון רוטשילד.")
N(p, 2)

p = para(doc)
T(p, "ביפו לבשה המעורבות אופי אחר. חברת אחוזת בית, שנוסדה ב-1906, רכשה "
     "מבעלים ערבים קרקע מצפון לעיר והקימה עליה ב-1909 שכונה מתוכננת מראש ובה "
     "חלוקת מגרשים אחידה, רחובות רחבים ותקנון בנייה מחייב. כץ מדגיש שהייתה זו "
     "יחידה עירונית מתוכננת ולא התרחבות אורגנית של גרעין קיים, ובכך דגם חדש "
     "בנוף העירוני של הארץ.")
N(p, 3)
T(p, " בחיפה, לעומת זאת, נותרה הנוכחות היהודית קטנה, כחמישה עשר אחוזים מן "
     "התושבים, והתרחבה אל מורדות הכרמל רק בשנים האחרונות של התקופה.")
N(p, 4)
T(p, " המעורבות הייתה גם מוסדית: מאז הקמת עיריית ירושלים בשנות השישים ישבו "
     ...
     "התקופה בידי משפחות האעיאן המוסלמיות, בני חוסייני, ח'אלדי ועלמי.")
N(p, 5)
...
p = para(doc)
T(p, "מכאן שהאוכלוסייה הערבית סיפקה לערים את גופן ואת מנגנוניהן. היא היוותה "
     "את מרבית תושביהן, החזיקה ברשויות המקומיות ובמשרות המנהל, וניהלה את "
     "מרבית המסחר והמלאכה: תעשיית הסבון של שכם, ייצוא השעורה מעזה, ומעל הכול "
     "ענף ההדרים של יפו.")
N(p, 7)
