...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      para('אלא שכאן פועלת פונקציית שעתוק האשם שבס\' 34יד, שעניינה כניסה למצב בהתנהגות פסולה. אבישי העמיד את עצמו במצב בהתנהגות נשלטת ופסולה: הוא נכנס לאתר הבנייה באיסור, חרף שלט שקרא במו עיניו והמתרה "סכנת חיים". למצער, אדם מן היישוב במקומו יכול היה להיות מודע, לפני היווצרות המצב, לכך שבאזור של סכנת חיים הוא עלול להידרש למעשה על חשבון זולתו. המעשה נעשה להצלת עצמו ולא להצלת אינטרס הזולת, ולכן הסיפא של ס\' 34יד(א) אינה עומדת לו וסייג הצורך נשלל. את תוצאת השעתוק קובע ס\' 34יד(ב): בעבירה המותנית בתוצאה רואים את העושה כמי שעשה את מעשהו באדישות, והמתה באדישות היא רצח לפי ס\' 300(א). אבישי יישא אפוא באחריות בעבירת רצח שעונשה מאסר עולם, אף שבשעת האירוע עצמו פעל בתנאי צורך.', { after: 200 }),
