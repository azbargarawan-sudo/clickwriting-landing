...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      para('הנוסח המוצע אינו פותר בעיה זו, אלא מחריף אותה. בנוסח המוצע נמחקת דרישת הכוונה המיוחדת כליל, ובמקומה באה נסיבה עובדתית, "שיש בה כדי לפגוע בבטחון המדינה". העבירה הופכת עבירה התנהגותית "שותקת", שהיסוד הנפשי הנדרש בה הוא מחשבה פלילית בלבד, מודעות להתנהגות ולנסיבות (ס\' 19 עד 20), הניתנת להוכחה אף בחזקת העיוורון המכוון. משמעות הדבר: כל מוסר ידיעה סודית בעלת פוטנציאל פגיעה, גם בהיעדר כל מטרה אנטי ביטחונית, היה צפוי למאסר עולם. ההשוואה בין המדליף למרגל לא זו בלבד שאינה נפתרת, היא מתרחבת. הנוסח המוצע אמנם מייתר את השימוש בהלכת הצפיות, אך רק משום שהוא מוותר על דרישת הכוונה מכל וכל ומרחיב את גבולות העבירה החמורה.', { after: 200 }),
