...
A.push(p('המדריך כולל שאלת פתיחה, 12 שאלות בארבעה נושאים מרכזיים שנבחרו מתוך כותרות סקירת הספרות (שלוש שאלות לכל נושא), ושאלת סיכום. השאלות פתוחות, אישיות וקצרות, ואינן מכוונות לתשובה מסוימת. לכל שאלה צורפו שאלות עזר קצרות, לשימוש רק אם התשובה קצרה מדי.'));
