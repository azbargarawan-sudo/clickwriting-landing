...
module.exports = {
  ...
  forum:    { type: 'book', author: 'פורום המרצות והמרצים למשפטים למען הדמוקרטיה', title: 'שינוי המשטר בישראל 2023: אסופת ניירות עמדה', editors: 'רונית לוין-שנור עורכת', year: '2026', short: 'פורום המרצות והמרצים' },
  hardofbook:{ type: 'book', author: 'אסף הרדוף', title: 'אשמים: טרילוגיה של משפט פלילי', vol: 'כרך II: סדר דין פלילי, חלק א', year: '2026', short: 'הרדוף **אשמים**' },
  ...
  stern:    { type: 'book', author: 'שי שטרן', title: 'קהילות במשפט', year: '2026', short: 'שטרן' },
  shapira:  { type: 'book', author: 'רון שפירא, איתי ברסלר-גונן ואילנית הלל', title: 'הליכי מעצר: מורה נבוכים', vol: 'מהדורה חמישית', year: '2025', short: 'שפירא, ברסלר-גונן והלל' },
  ...
  sapir:    { type: 'hraw', text: 'יואב ספיר "שיח הזכויות, פופוליזם והתגובה לפשיעה בחברה הערבית: על הצורך בהגנה חוקתית משודרגת על זכויות בפלילים" **משפטים על אתר** (סימפוזיון על אתר, גיליון כא, 2022) https://lawjournal.huji.ac.il/article/12/1903', short: 'ספיר' },
  ...
  hardof23: { type: 'article', author: 'אסף הרדוף', title: 'זכות מפלה ופריווילגיות של מדינה: חיסיון לטובת הציבור ונסיגה לטובת התקפה', journal: 'מחקרי משפט', vol: 'לד', start: '1', year: '2022', short: 'הרדוף "זכות מפלה ופריווילגיות של מדינה"' },
  ...
  weisburd: { type: 'other', text: 'David Weisburd & John E. Eck, _What Can Police Do to Reduce Crime, Disorder, and Fear?_, 593 ANNALS AM. ACAD. POL. & SOC. SCI. 42@ (2004)', short: 'Weisburd & Eck' },
  ...
  harmelin: { type: 'hraw', text: 'איתי הרמלין "אומרים הסכמה (לחיפוש) יש בעולם. מה זאת הסכמה?" **75 שנות עצמאות במשפט: שופטים מספרים על פסקי דין משבעים וחמש שנות שפיטה** (דפנה ברק-ארז עורכת ראשית, 2023)', short: 'הרמלין' },
