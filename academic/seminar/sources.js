...
module.exports = {
  ...
  podam:    { type: 'article', author: 'אפרת פודם, אסף דרעי ושיר טולדנו', title: 'אם לא תמחק יבוא שוטר: דמותו של השוטר בחברה בראי מגמת תביעות הדיבה מצד שוטרים', journal: 'מעשי משפט', vol: 'יד', start: '[עמוד]', year: '2023', short: 'פודם, דרעי וטולדנו' },
