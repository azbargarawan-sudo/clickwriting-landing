...
SEC_A = [
    ...
    ("הראיות הבינלאומיות זהירות יותר. מטא-אנליזה של 79 הערכות של תוכניות לנוער מצאה ירידה קטנה עד בינונית בעבריינות חוזרת, לצד עלייה ניכרת בתחושת ההגינות ובשביעות הרצון של הנפגעים ושל הנערים (Kimbrell et al., 2023). מטא-אנליזה שכללה גם מבוגרים מצאה ירידה קטנה בעבריינות חוזרת כללית, ללא השפעה על עבריינות אלימה חוזרת (Fulham et al., 2025).", None),
...
BIB_HE = [
    ...
    "קלר-חלמיש, כ' ופלג-קוריאט, ע' (2020). ממחאה לאיחוי: מחאת #MeToo כרקע לפיתוח והנגשה של תהליכי צדק מאחה במקרים של פגיעה מינית. קרימינולוגיה ישראלית, ט, 33-53. https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3901353",
]
BIB_EN = [
