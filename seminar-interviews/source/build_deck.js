...
// ==========================================================================
{
  ...
  s.addText('מגישות:  [שם מלא]  |  [שם מלא]  |  [שם מלא]', { x: 3.3, y: 5.16, w: W - 6.6, h: 0.32, fontFace: F, fontSize: 13, bold: true, color: INK, align: 'center', rtlMode: true, margin: 0 });
  s.addText('בהנחיית: ד"ר שנהב פרץ', { x: 3.3, y: 5.52, w: W - 6.6, h: 0.3, fontFace: F, fontSize: 13, color: INK, align: 'center', rtlMode: true, margin: 0 });
...
// ==========================================================================
{
  ...
  s.addText('חלוקת ההצגה: מציגה א׳ פרקים 1 עד 2  |  מציגה ב׳ פרקים 3 עד 4  |  מציגה ג׳ פרקים 5 עד 6  |  משך כולל: 15 דקות',
    { x: M + 0.24, y: 5.62, w: CW - 0.48, h: 0.62, fontFace: F, fontSize: 13, color: INK, align: 'center', rtlMode: true, margin: 0, valign: 'middle' });
  s.addNotes('להציג את סדר הדברים ואת חלוקת הזמן בין שלוש המציגות. כחצי דקה.');
}
...
// ==========================================================================
{
  ...
  const eth = [
    ...
    'שישה ראיונות בעברית, חמישה בערבית ואחד באמהרית. כל אחת משלוש חברות הצוות ערכה ארבעה ראיונות.',
...
// ==========================================================================
{
  ...
  const data = [
    ['נבדקה פעמיים, באיחור של כשנתיים', '12 שנות לימוד; סייעת בגן', 'רמלה', '54', 'לילה נגילי', '1'],
    ['נבדקה אחרי פנייה טלפונית באמהרית', '4 שנות לימוד; עובדת ניקיון', 'חולון', '58', 'טגאיה סמאנך', '2'],
    ['נבדקת מתחת לגיל הזימון, בהפניית רופאה', 'תואר ראשון; מורה', 'ערערה בנגב', '47', 'עאליה אבו עראר', '3'],
    ['בדיקה ראשונה בגיל 51 אחרי שנתיים', '12 שנות לימוד; עובדת במספרה', 'רמלה', '52', "מראם ח'טיב", '4'],
...
const themes = [
  {
    ...
    c: "מראם ח'טיב, בת 52, רמלה  |  נבדקה לראשונה בגיל 51",
  ...
  },
  {
    ...
    c: 'עאליה אבו עראר, בת 47, ערערה בנגב  |  מצטטת אישה מן התור לניידת',
  ...
  },
  {
    ...
    c: 'טגאיה סמאנך, בת 58, חולון  |  עובדת ניקיון בשכר יומי',
  ...
  },
  {
    ...
    c: 'לילה נגילי, בת 54, רמלה  |  לא נבדקה מאז',
    note: 'זו התמה היחידה שכולה מאיצים, וממנה נגזרות רוב ההמלצות. הניגוד בין מראם ללילה הוא הלב של השקף.',
  },
];
...
// ==========================================================================
{
  ...
  s.addText('המרכז האקדמי פרס  |  החוג למנהל מערכות בריאות  |  בהנחיית ד"ר שנהב פרץ  |  תשפ"ו',
